...
//   fbq('trackCustom', 'Add to Wishlist');
// });

// $('#nav-download-app-btn').on('click', function () {
//   fbq('trackCustom', 'Add to Wishlist');
// });
...
// const navDownloadAppBtn = document.getElementById('what-to-download-app-btn');
// navDownloadAppBtn.onclick = fbPixelsEvent;

const nawDownloadAppButton = document.getElementById('nav-download-app-btn');
  nawDownloadAppButton.addEventListener(
    'click', 
    function() { 
      fbq('track', 'Add to Wishlist');
    });


const wantToDownloadAppButton = document.getElementById('what-to-download-app-btn');
wantToDownloadAppButton.addEventListener(
    'click', 
    function() { 
      fbq('track', 'Add to Wishlist');
    });
